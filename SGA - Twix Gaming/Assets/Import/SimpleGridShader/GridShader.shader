...
Shader "PDT Shaders/TestGrid" {
	Properties {
		...
		_LineEmission ("Line Emission", Range(0,10)) = 1
		_LineColor ("Line Color", Color) = (1,1,1,1)
		_CellEmission ("Cell Emission", Range(0,10)) = 0
...
/* UNITY: Original start of shader */
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			if (frac(uv.x*gsize) <= _LineSize || frac(uv.y*gsize) <= _LineSize)
			{
				...
				color = _LineColor += _LineEmission;
				//o.Emission = _LineEmission * _LineColor;
				o.Emission = _EmissionColor.rgb * _LineEmission;
				o.Emission = _EmissionColor.rgb * _LineEmission;
			}
